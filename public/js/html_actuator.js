class HTMLActuator {
  constructor(remotePlayer) {
    if (remotePlayer) {
      ...
      this.scoreContainer   = document.querySelector("#player-two .score-container");
      this.bestContainer    = document.querySelector("#player-two .best-container");
    } else {
      ...
      this.scoreContainer   = document.querySelector("#player-one .score-container");
      this.bestContainer    = document.querySelector("#player-one .best-container");
    }
    this.score = 0;
